...
Для корректной работы приложения необходимо добавить API-ключ Яндекс Расписаний: 

   1.    Создайте копию файла Configuration.example.plist.
   2.    Переименуйте копию в Configuration.plist.
   3.    Укажите ваш API-ключ в поле API_KEY внутри Configuration.plist
